...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Deposit', fields ['charge', 'user']
        db.create_unique('direct_payments_deposit', ['charge_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Deposit', fields ['charge', 'user']
        db.delete_unique('direct_payments_deposit', ['charge_id', 'user_id'])
